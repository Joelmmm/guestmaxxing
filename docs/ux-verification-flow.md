...
* **The Solution:** The confirmation email includes a link to `reserva.com/manage`. When the guest arrives there, they enter their email and receive a new OTP — no password, no separate signed-token infrastructure.
